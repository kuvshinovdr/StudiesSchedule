...
### Возврат от второй задачи к первой

Велика вероятность нехватки аудиторий при решении второй задачи. Менять задачи местами (решать сначала вторую) нет смысла, поскольку нам сразу же жёстко не хватит аудиторий.

Предлагается:

1. "Запретить" временной слот назначений, которым не хватило аудиторий.
1. Поменять значение временного слота на нулевое (или случайное, или эвристическое).
1. Поменять значение аудитории на нулевое (или случайное, или эвристическое).
1. Заново решить первую задачу.

Поскольку алгоритм принимает произвольную раскраску и разрешает конфликты, то он может просто исправлять уже имеющуюся схему.
